...
def TaskExe():
    def Music():
        ...
        if 'Aadat' in musicName:
            os.startfile('Music\\Aadat - Ninja.mp3')
    ...
    def Whatsapp():
        ...
        if 'Dd' in name:
            ...
            min = int(takecommand())
            pywhatkit.sendwhatmsg("+919541018686",msg,hour,min,20)
            Speak("Okay Sir, sending the message!")
            ...
            Speak("Time in minutes")
            min = int(takecommand())
            pywhatkit.sendwhatmsg("+916204814723",msg,hour,min,20)
            Speak("Okay Sir, sending the message!")
        ...
        #     Speak("Time in minutes")
        #     min = int(takecommand())
        #     pywhatkit.sendwhatmsg("+919546542733", msg, hour, min, 20)
        #     Speak("Okay Sir, sending the message!")
        else:
            Speak("Tell me the message")
            msg = takecommand()
            phone = int(takecommand("Enter the number"))
            Speak("Tell me the time sir")
            Speak("Time in hour")
            hour = int(takecommand())
            Speak("Time in minutes")
    ...
    def Reader():
        ...
        if 'machine learning' in name:
            ...
            os.startfile('D:\\HANDS%20ON%20MACHINE%20LEARNING%20BOOK.pdf')
            book = open('D:\\HANDS%20ON%20MACHINE%20LEARNING%20BOOK.pdf', 'rb')
        ...
        elif 'charlie and the chocolate factory' in name:
            os.startfile('D:\\Charlie-and-the-Chocolate-Factory.pdf')
            book = open('D:\\Charlie-and-the-Chocolate-Factory.pdf', 'rb')
            pdfreader = PyPDF2.PdfFileReader(book)
            pages = pdfreader.getNumPages()
            Speak(f"Number Of Pages In This Books Are {pages}")
            Speak("From Which Page I Have To Start Reading ? Please enter it manually :")
    ...
    def screenshot():
        ...
        path = takecommand()
        path1name = path + ".png"
        path1 = "C:\\Users\\dell\\Pictures\\Screenshots" + path1name
        kk = pyautogui.screenshot()
        kk.save(path1)
        os.startfile("C:\\Users\\dell\\Pictures\\Screenshots")
    ...
    while True:
        ...
        if 'hello' in query:
            Speak("Hello! , I Am Optimus .")
            Speak("Your Personal AI Assisstant")
            ...
            Speak("Just Say Wake Up optimus!")
            break

        elif 'youtube search' in query:
            Speak("OK sIR , This Is What I found For Your Search!")
            query = query.replace("optimus", "")
            ...
            Speak("Ok Sir , Wait A Second!")
            webbrowser.open('https://www.google.com/maps/@30.7770195,76.581885,15z')
            ...
            remeberMsg = remeberMsg.replace("optimus", "")
